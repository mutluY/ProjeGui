...
public class TestergebnisseController {
	...
	public void allen_b(ActionEvent e) {
		...
		try {
			...
			AnchorPane root = (AnchorPane) FXMLLoader.load(getClass().getResource("Testergebnisse2.fxml"));
	...
	public void gescheiterte_b(ActionEvent e) {
		...
		try {
			Stage stage = new Stage();
			AnchorPane root = (AnchorPane) FXMLLoader.load(getClass().getResource("Testergebnisse3.fxml"));
			stage.setScene(new Scene(root));
			stage.setTitle("Klimaschranksteuerer");
			stage.setWidth(600);
			stage.setHeight(400);
